...
export const Projetos = () => {
  ...
  return (
    <div className={mostrar ? "flex flex-col items-center justify-between" : "h-screen flex flex-col items-center justify-between"} id="projetos">
      <h2 className="text-3xl mt-14">Projetos</h2>
