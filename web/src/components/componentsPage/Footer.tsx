  ...
  return (
    <div className="h-screen flex items-center justify-center flex-col" id="contato">
      <div className="h-4/5 w-[95%] flex flex-col items-center justify-between p-5">
        ...
        <Card className="h-60 w-[50%] flex items-center justify-center space-x-5">
          ...
          <div onClick={Discord} className="hover:bg-violet-600 rounded-md p-2"> <Image src={"/discord.png"} alt={""} height={50} width={50}/> </div>
        </Card>
        <div></div>
      </div>
    </div>
